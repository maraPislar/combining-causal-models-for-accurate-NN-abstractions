...
from utils import de_morgan_sampler, generate_all_combinations_de_morgan, construct_de_morgan_input
...
def main():
    ...
    parser.add_argument('--results_path', type=str, default='training_gpt2_binary_changedO_results/', help='path to the results folder')
